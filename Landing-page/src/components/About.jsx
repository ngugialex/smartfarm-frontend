...
const About = () => {
  return (
    <div className='bg-green-50 pt-12 pb-12'>
      ...
      <div className='text-[18px] flex gap-32 ml-6 mt-4'>
        <div className="h-56 ">
        <b>Mission of SmartFarm</b>
        <p className="h-56 text-justify leading-relaxed ">The mission of SmartFarm is to empower farmers with advanced, data-driven tools and 
